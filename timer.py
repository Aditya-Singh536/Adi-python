...
def hour():
    ...
    for i in range(1,ask_user_time):
        ask_user_time -= 1
        print(f"Countdown to {ask_user_time2} hours/hour is on:{ask_user_time/60:.2f} minutes.")
        time.sleep(1)
...
def min():
    ...
    for i in range(1,ask_user_time):
        ask_user_time -= 1
        print(f"Countdown to {ask_user_time2} minutes/minute is on:{ask_user_time} seconds or {ask_user_time/60:.2f} minutes.")
        time.sleep(1)
